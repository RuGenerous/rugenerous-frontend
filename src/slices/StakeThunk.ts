...
import { abi as RuGenerousStakingABI } from "../abi/RuGenerousStakingv2.json";
...
import { IERC20, RuGenerousStakingv2, StakingHelper } from "src/typechain";
...
export const changeApproval = createAsyncThunk(
  ...
  async ({ token, provider, address, networkID }: IChangeApprovalAsyncThunk, { dispatch }) => {
    ...
    const ohmContract = new ethers.Contract(addresses[networkID].RUG_ADDRESS as string, ierc20ABI, signer) as IERC20;
