...
interface PrizePoolAbi2Interface extends ethers.utils.Interface {
  functions: {
...
export type ErrorAwardingExternalERC721Event = TypedEvent<[string] & { error: string }>;
...
export class PrizePoolAbi2 extends BaseContract {
  ...
  interface: PrizePoolAbi2Interface;
  ...
  functions: {
    ...
    isControlled(controlledToken: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  filters: {
    ...
    "ErrorAwardingExternalERC721(bytes)"(error?: null): TypedEventFilter<[string], { error: string }>;

    ErrorAwardingExternalERC721(error?: null): TypedEventFilter<[string], { error: string }>;

    "Initialized(address,uint256)"(
      reserveRegistry?: null,
      maxExitFeeMantissa?: null,
    ): TypedEventFilter<[string, BigNumber], { reserveRegistry: string; maxExitFeeMantissa: BigNumber }>;
  ...
  estimateGas: {
    ...
    isControlled(controlledToken: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    isControlled(controlledToken: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
