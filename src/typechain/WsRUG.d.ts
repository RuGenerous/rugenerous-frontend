...
interface WsRUGInterface extends ethers.utils.Interface {
  functions: {
    ...
    "sRUGTowRUG(uint256)": FunctionFragment;
    "symbol()": FunctionFragment;
    "totalSupply()": FunctionFragment;
    "transfer(address,uint256)": FunctionFragment;
    "transferFrom(address,address,uint256)": FunctionFragment;
    "unwrap(uint256)": FunctionFragment;
    "wRUGTosRUG(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "sRUGTowRUG", values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "wRUGTosRUG", values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "sRUGTowRUG", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "symbol", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "totalSupply", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "transfer", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "transferFrom", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "unwrap", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "wRUGTosRUG", data: BytesLike): Result;
...
export class WsRUG extends BaseContract {
  ...
  functions: {
    ...
    sRUGTowRUG(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    wRUGTosRUG(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    sRUGTowRUG(_amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    wRUGTosRUG(_amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
