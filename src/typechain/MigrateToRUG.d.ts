...
export class MigrateToRUG extends BaseContract {
  ...
  functions: {
    ...
    reclaim(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    initialize(_RUG: string, _aRUG: string, swapDuration: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    reclaim(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    reclaim(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    renounceOwnership(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    senderInfo(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
